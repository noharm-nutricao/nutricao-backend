...
def _cleanup():
    session.execute(text("DELETE FROM demo.nutricional_triagem WHERE nratendimento >= 900000"))
    session.execute(text("DELETE FROM demo.nutricional_alerta WHERE nratendimento >= 900000"))
    session.execute(text("DELETE FROM demo.nutricional_avaliacao WHERE nratendimento >= 900000"))
    session.execute(text("DELETE FROM demo.nutricional_glim WHERE nratendimento >= 900000"))
    session.execute(text("DELETE FROM demo.nutricional_nrs WHERE nratendimento >= 900000"))
    session.execute(text("DELETE FROM demo.nutricional_d7 WHERE nratendimento >= 900000"))
